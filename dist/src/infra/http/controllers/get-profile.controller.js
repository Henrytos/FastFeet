...
const user_body_dto_1 = require("../dtos/user-body.dto");
const use_roles_guards_decorator_1 = require("../guards/use-roles-guards.decorator");
let GetProfileController = class GetProfileController {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async handler({ sub }) {
        ...
        return {
            user: user_presenter_1.UserPresenter.toHTTP(user),
        };
    }
};
...
], GetProfileController.prototype, "handler", null);
exports.GetProfileController = GetProfileController = __decorate([
