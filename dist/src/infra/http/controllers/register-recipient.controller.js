...
exports.RegisterRecipientController = void 0;
...
const delivery_address_does_not_exist_messge_dto_1 = require("../dtos/delivery-address-does-not-exist-messge.dto");
const use_roles_guards_decorator_1 = require("../guards/use-roles-guards.decorator");
const registerRecipientBodySchema = zod_1.z.object({
    name: zod_1.z.string().min(3),
    email: zod_1.z.string().email(),
});
let RegisterRecipientController = class RegisterRecipientController {
    constructor(registerRecipientUseCase) {
        this.registerRecipientUseCase = registerRecipientUseCase;
    }
    async handler(recipient, administrator) {
...
exports.RegisterRecipientController = RegisterRecipientController;
__decorate([
    (0, common_1.Post)(),
    ...
    (0, swagger_1.ApiBadRequestResponse)({
        type: delivery_address_does_not_exist_messge_dto_1.DeliveryAddressDoesNotExistMessageDTO,
    ...
    __param(0, (0, common_1.Body)(new zod_validation_pipe_1.ZodValidationPipe(registerRecipientBodySchema))),
    __param(1, (0, current_user_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], RegisterRecipientController.prototype, "handler", null);
exports.RegisterRecipientController = RegisterRecipientController = __decorate([
    (0, swagger_1.ApiTags)('recipient'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('/recipients'),
    __metadata("design:paramtypes", [register_recipient_use_case_1.RegisterRecipientUseCase])
], RegisterRecipientController);
//# sourceMappingURL=register-recipient.controller.js.map